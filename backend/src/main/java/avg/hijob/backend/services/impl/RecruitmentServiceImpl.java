...
//      try{
          ...
          if(cv.isEmpty() || coverLetter.isEmpty()) {
              ...
              return new ResponseRecruitment(recruitment.getId(), recruitment.getUser().getId(),
                      ...
                      recruitment.getCoverLetter(), recruitment.getAppliedAt(), recruitment.getDeletedAt(), recruitment.getUser().getFullName(), recruitment.getJob().getTitle());
          }
//      }catch (Exception e) {
    ...
    public ResponseRecruitment updateRecruitment(String id, RequestRecruitment requestRecruitment) {
        try{
            if(recruitmentRepository.findById(id).isEmpty()){
                ...
                recruitment.setCv(String.valueOf(requestRecruitment.getCv()));
                recruitment.setCoverLetter(String.valueOf(requestRecruitment.getCoverLetter()));
                recruitmentRepository.save(recruitment);
